...
/**
 * Payment aggregate. All state changes go through {@link #transitionTo}, which refuses illegal
 * moves — the controller and repository never mutate {@code status} directly. This is the DDD
 * point: behaviour lives on the aggregate, not in an anemic service.
 */
public class Payment {
    ...
    /** A brand-new intent, before persistence. */
